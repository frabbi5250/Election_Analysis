...
file_to_load = os.path.join(r'C:\Users\rabbi\Desktop\ClassFolder\Election_Analysis\Resources\election_results (1).csv')
# Add a variable to save the file to a path.
file_to_save = os.path.join(r'C:\Users\rabbi\Desktop\ClassFolder\Election_Analysis\analysis\election_analysis.txt')
